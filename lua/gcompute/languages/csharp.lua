...
LANGUAGE:GetTokenizer ()
	...
	:AddPlainSymbol   (GCompute.TokenType.MemberIndexer,        ".")
	:AddPlainSymbols  (GCompute.TokenType.Operator,            {"#", "!", "~", "+", "-", "^", "&", "|", "*", "/", "=", "<", ">", "(", ")", "{", "}", "[", "]", "%", "?", ":", ","})
...
LANGUAGE:AddKeywords (GCompute.KeywordType.DataType, {"typedef", "static", "public", "private", "protected", "virtual", "override", "new"})
LANGUAGE:AddKeywords (GCompute.KeywordType.DataType, {"unsigned", "signed"})
LANGUAGE:AddKeywords (GCompute.KeywordType.DataType, {"void", "bool", "char", "short", "int", "long", "float", "double", "string"})
