...
LANGUAGE:AddKeywords ({"if", "then", "else", "elseif", "end", "while", "for", "do", "break", "repeat", "until", "return"}, GCompute.KeywordType.Control)
LANGUAGE:AddKeyword ("continue", GCompute.KeywordType.Control)
LANGUAGE:AddKeywords ({"not", "and", "or"}, GCompute.KeywordType.Operator)
LANGUAGE:AddKeywords ({"true", "false", "nil"}, GCompute.KeywordType.Constant)