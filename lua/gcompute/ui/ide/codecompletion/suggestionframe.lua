...
function self:AddObjectDefinition (objectDefinition)
	...
	listBoxItem.SuggestionType = GCompute.IDE.CodeCompletion.SuggestionType.Definition
...
function self:AddKeyword (keyword)
	...
	listBoxItem.SuggestionType = GCompute.IDE.CodeCompletion.SuggestionType.Keyword
...
function self:GetSelectedItemType ()
	local listBoxItem = self.ListBox:GetSelectedItem ()
	if not listBoxItem then return GCompute.IDE.CodeCompletion.SuggestionType.None end
...
function self:UpdateToolTip ()
	...
	hideToolTip = hideToolTip or suggestionType == GCompute.IDE.CodeCompletion.SuggestionType.None
	hideToolTip = hideToolTip or suggestionType == GCompute.IDE.CodeCompletion.SuggestionType.Keyword
