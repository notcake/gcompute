GCompute.IDE.CodeEditorKeyboardMap:Register (KEY_F,
...
GCompute.IDE.CodeEditorKeyboardMap:Register (KEY_G,
	function (self, key, ctrl, shift, alt)
		if not ctrl then return false end
		...
		GCompute.OpenGoToDialog (
			function (line)
				...
				self:SetCaretPos (GCompute.IDE.LineColumnLocation (line, 0))
			end
		)
	end
)