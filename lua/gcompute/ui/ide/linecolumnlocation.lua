local self = {}
GCompute.IDE.LineColumnLocation = GCompute.MakeConstructor (self)
...
function self:AddColumns (columns)
	local lineColumnLocation    = GCompute.IDE.LineColumnLocation ()
...
function self:Clone ()
	return GCompute.IDE.LineColumnLocation (self.Line, self.Column)
end
...
function self:__add (lineColumnLocation)
	return GCompute.IDE.LineColumnLocation (
