local self = {}
GCompute.IDE.DeletionAction = GCompute.MakeConstructor (self, GCompute.UndoRedoItem)
...
function self:ctor (codeEditor, selectionStartLocation, selectionEndLocation, deletionStartLocation, deletionEndLocation, text)
	...
	self.DeletionStartLocation  = GCompute.IDE.LineCharacterLocation (deletionStartLocation)
	self.DeletionEndLocation    = GCompute.IDE.LineCharacterLocation (deletionEndLocation)
	self.Text = text
