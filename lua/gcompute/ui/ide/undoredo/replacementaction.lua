local self = {}
GCompute.IDE.ReplacementAction = GCompute.MakeConstructor (self, GCompute.UndoRedoItem)
...
function self:ctor (codeEditor, selectionStartLocation, selectionEndLocation, originalText, finalText)
	...
	self.SelectionStartLocation = GCompute.IDE.LineCharacterLocation (selectionStartLocation)
	self.SelectionEndLocation   = GCompute.IDE.LineCharacterLocation (selectionEndLocation)
	
	self.InsertionLocation      = GCompute.IDE.LineCharacterLocation (self.SelectionStartLocation)
	self.FinalLocation          = GCompute.IDE.LineCharacterLocation (self.SelectionStartLocation)
